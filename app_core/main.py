...
class CentauriWatchdog(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        ctk.CTkButton(btn_ai_col, text="Clear all zones", fg_color="#21262d", width=120, command=lambda: self.ignore_zones.clear()).pack(pady=2)
    ...
    def build_sidebar(self):
        ...
        ctk.CTkButton(self.sidebar_frame, text="Telegram remote control", fg_color="#1f6feb", hover_color="#388bfd", command=self.open_telegram_manager).pack(fill="x", padx=10, pady=(0, 5))
    ...
    def undo_zone(self): 
        if self.ignore_zones: self.ignore_zones.pop()
